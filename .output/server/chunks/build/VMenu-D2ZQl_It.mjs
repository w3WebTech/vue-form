import { shallowRef, ref, toRef, computed, createVNode, withDirectives, vShow, watch, Fragment, resolveDirective, mergeProps, inject, provide, toRaw, nextTick } from 'vue';
import { V as VExpandTransition } from './index-D38G6C1I.mjs';
import { ax as defineComponent, p as propsFactory, I as IconValue, m as makeComponentProps, d as makeTagProps, g as genericComponent, l as useRender, a6 as VDefaultsProvider, M as MaybeTransition, a0 as EventProp, L as makeBorderProps, b as makeDensityProps, aa as makeDimensionProps, N as makeElevationProps, O as makeRoundedProps, ad as makeRouterProps, e as makeThemeProps, P as makeVariantProps, ae as Ripple, am as useLink, f as provideTheme, af as useBorder, ag as useVariant, z as useDensity, ah as useDimension, ai as useElevation, al as useRounded, ay as deprecate, an as genOverlays, V as VIcon, r as useTextColor, A as useBackgroundColor, B as provideDefaults, o as omit, h as useProxiedModel, k as getUid, a1 as getCurrentInstance, Y as deepEqual, az as focusChild, D as focusableChildren, aA as getNextElement, a2 as getPropertyFromItem } from './server.mjs';
import { u as useSsrBoot } from './ssrBoot-BtvJZs44.mjs';
import { c as createSimpleFunctional, V as VAvatar } from './VAvatar-BZtC_Qdy.mjs';
import { V as VDivider } from './VDivider-UF-z31IW.mjs';
import { m as makeVOverlayProps, u as useScopeId, V as VMenuSymbol, a as VOverlay } from './VOverlay-CsNFlnFM.mjs';
...
export { VList as V, VListItem as a, VListItemTitle as b, VListItemSubtitle as c, VMenu as d, makeItemsProps as m, transformItem$1 as t, useItems as u };
