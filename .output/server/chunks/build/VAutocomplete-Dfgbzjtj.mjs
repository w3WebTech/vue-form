...
import { p as propsFactory, o as omit, a4 as makeTransitionProps, g as genericComponent, u as useLocale, h as useProxiedModel, r as useTextColor, Z as wrapInArray, l as useRender, V as VIcon, a5 as ensureValidVNode, a6 as VDefaultsProvider, a7 as noop, a8 as matchesSelector } from './server.mjs';
import { u as useForm } from './form-CtAJx0Pr.mjs';
import { f as forwardRefs } from './forwardRefs-BSTjJZPU.mjs';
import { u as useItems, d as VMenu, V as VList, a as VListItem } from './VMenu-D2ZQl_It.mjs';
...
const VAutocomplete = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    watch(isFocused, (val, oldVal) => {
      ...
      if (val) {
        isSelecting.value = true;
        search.value = props.multiple ? "" : String((_a2 = (_a = model.value.at(-1)) == null ? void 0 : _a.props.title) != null ? _a2 : "");
        isPristine.value = true;
        nextTick(() => isSelecting.value = false);
      } else {
