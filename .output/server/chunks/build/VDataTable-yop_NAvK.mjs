import { shallowRef, computed, toRef, createVNode, mergeProps, Fragment, createTextVNode, withModifiers, toDisplayString, ref, nextTick, watchEffect, provide, inject, capitalize, watch } from 'vue';
import { p as propsFactory, I as IconValue, L as makeBorderProps, m as makeComponentProps, b as makeDensityProps, N as makeElevationProps, O as makeRoundedProps, c as makeSizeProps, d as makeTagProps, e as makeThemeProps, P as makeVariantProps, g as genericComponent, h as useProxiedModel, u as useLocale, v as useRtl, f as provideTheme, w as useDisplay, B as provideDefaults, y as useResizeObserver, j as createRange, l as useRender, a as VBtn, Q as defineFunctionalComponent, C as convertToUnit, R as makeLoaderProps, S as useLoader, A as useBackgroundColor, T as LoaderSlot, U as getObjectValueByPath, W as isOn, X as keyValues, Y as deepEqual, Z as wrapInArray, $ as isEmpty, V as VIcon, a0 as EventProp, a1 as getCurrentInstance, i as clamp, a2 as getPropertyFromItem, a3 as consoleError } from './server.mjs';
import { V as VSelect, m as makeFilterProps, u as useFilter } from './filter--QOHq2bS.mjs';
import { V as VCheckboxBtn } from './VCheckboxBtn-JiRxhpjI.mjs';
import { m as makeVTableProps, V as VTable } from './VTable-DbXYOtR_.mjs';
