import { toRef, createVNode, computed, withDirectives, vShow, Fragment, mergeProps, resolveDirective, watch, onScopeDispose, shallowRef, ref, createTextVNode, unref, watchEffect, nextTick } from 'vue';
...
import { p as propsFactory, Y as deepEqual, m as makeComponentProps, t as makeGroupProps, d as makeTagProps, e as makeThemeProps, P as makeVariantProps, g as genericComponent, f as provideTheme, x as useGroup, B as provideDefaults, l as useRender, I as IconValue, a0 as EventProp, L as makeBorderProps, b as makeDensityProps, N as makeElevationProps, F as makeGroupItemProps, O as makeRoundedProps, ad as makeRouterProps, c as makeSizeProps, ae as Ripple, u as useLocale, af as useBorder, ag as useVariant, z as useDensity, ai as useElevation, al as useRounded, ao as useSize, h as useProxiedModel, G as useGroupItem, am as useLink, an as genOverlays, V as VIcon, a6 as VDefaultsProvider, y as useResizeObserver, aa as makeDimensionProps, a1 as getCurrentInstance, ah as useDimension, as as useToggleScope, C as convertToUnit, o as omit, a4 as makeTransitionProps, Z as wrapInArray, a5 as ensureValidVNode, w as useDisplay, at as debounce, i as clamp, a8 as matchesSelector, a2 as getPropertyFromItem } from './server.mjs';
import { m as makeItemsProps, u as useItems, d as VMenu, V as VList, a as VListItem } from './VMenu-D2ZQl_It.mjs';
import { V as VDialogTransition } from './dialog-transition-CRChXgJR.mjs';
import { V as VCheckboxBtn } from './VCheckboxBtn-JiRxhpjI.mjs';
import { b as VExpandXTransition } from './index-D38G6C1I.mjs';
...
export { VSelect as V, VChip as a, makeSelectProps as b, useScrolling as c, VVirtualScroll as d, makeFilterProps as m, useFilter as u };
